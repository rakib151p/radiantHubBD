...
<body class="bg-gray-100">
    ...
    <section class="py-12">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-left text-gray-800 mb-8"><?php echo 'Search result of '.$state.' '.$city.' '.$area; ?></h2>
            <!-- Dropdown Filters -->
            <div class="flex mb-8">
                <input type="hidden" id="districtDropdown" name="district" value="<?php echo $state; ?>">
