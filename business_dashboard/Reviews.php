    ...
    <div class="flex h-screen">
        ...
        <div class="bg-gray-800 text-gray-100 w-64 space-y-6 py-7 px-2" id="dashboard">
            ...
            <nav class="mt-10">
                ...
                <a href="Reviews.php"
                    class="block bg-pink-600 py-2.5 px-4 rounded-lg mt-2 hover:bg-pink-500">Reviews</a>
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
            <div class="main-content p-4 flex-1">
                <div class="header flex justify-between items-center mb-4">
                    <h2 class="text-2xl font-bold" style="margin:0 0 0 40px;">Our valuable testimonials</h2>
                        ...
                        <tbody>
                            ...
                            if ($result) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<td class="rating">' . $row['star'] . ' / 5</td>';
                                    echo '</tr>';
                                }
                            }
                            ?>
