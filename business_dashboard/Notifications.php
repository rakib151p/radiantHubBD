...
$sql_update = "UPDATE `notifications_by_admin` SET `status` = 1 WHERE `shop_id` = '$shop_id'";
        ...
        <div class="bg-gray-800 text-gray-100 w-64 space-y-6 py-7 px-2" id="dashboard">
            ...
            <nav class="mt-10">
                ...
                <a href="Notifications.php"
                    class="block bg-pink-600 py-2.5 px-4 rounded-lg mt-2 hover:bg-pink-500">Notifications&nbsp;<?php if ($_SESSION['notification'] > 0)
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
            <div class="main-content p-4 flex-1">
                <div class="header flex justify-between items-center mb-4">
                    <h2 class="text-2xl font-bold" style="margin:0 0 0 40px;">Notifications</h2>
                ...
                if ($result_notify->num_rows > 0) {
                    ...
                    role="alert"><h4 class="font-bold text-lg">' . $row_notify['subject'] . '</h4>';
                        ...
                        echo '<p class="mb-0">Admin, RadientHub BD
                                    </p><span id="current-time" class="absolute bottom-0 right-0 mb-2 mr-2 text-sm text-gray-500">' . $row_notify['date_time'] . '</span></div>';
                    }
                }
                ?>
