...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  // Store business name and website in session
  $_SESSION['business-name'] = $_POST['business-name'];
  $_SESSION['website'] = $_POST['website'];
  $_SESSION['business-info'] = $_POST['business-info'];
  $_SESSION['business-title'] = $_POST['business-title'];
...
<body class="bg-gray-100">
  <div class="min-h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-4xl">
      <div>
        <a href="step2.php" class="bg-pink-500 hover:bg-pink-700 text-white font-bold py-2 px-4 rounded">
          &larr;
        </a>
        <h2 class="text-xl font-bold text-center text-gray-700 mb-8">
          Enter Your Shop Address
        </h2>
      </div>
      <form action="step4.php" method="POST" id="shopAddressForm">
        <div class="mb-4">
        ...
        <div class="mb-4">
          ...
          <select id="upazilla" name="upazilla"
            class="border border-gray-300 p-2 rounded-lg w-full focus:outline-none focus:border-pink-600" required>
            <option value="<?php if (isset($_SESSION['upazilla']))
            echo $_SESSION['upazilla']; ?>" disabled selected>Select Your Upazilla</option>
          </select>
        </div>
        <div class="mb-4">
          <label for="area" class="block text-gray-700 font-bold mb-2">Shop Area *</label>
          <input type="text" id="area" name="area" value="<?php if (isset($_SESSION['area']))
            echo $_SESSION['area']; ?>"
            class="border border-gray-300 p-2 rounded-lg w-full focus:outline-none focus:border-pink-600" required />
        </div>
        <div class="mb-4">
        ...
        <!-- <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Point Your Address on the Map *</label>
                    <div id="map"></div>
                <!-- </div> -->
        <div class="mb-4">
          <table>
  ...
  <script>
    ...
    const citiesBydistrict = {
      ...
      Dhaka: ["Natun bazar","Badda","Uttara","Dhamrai", "Dohar", "Keraniganj", "Nawabganj", "Savar"],
      Dinajpur: [
        "Birampur",
        "Birganj",
        "Biral",
